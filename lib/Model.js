...
export default class Model {
    ...
    clone(preserveRelations = true) {
        ...
        const model = new this.constructor(data)

        if (preserveRelations) {
            model._truck.relation = this._truck.relation
            model._truck.collection = this._truck.collection
        }
    ...
    toObject() {
        ...
        each(keys(this._option('hasOne')), field => {
            obj[field] = this[field].mode.toObject()
        })
